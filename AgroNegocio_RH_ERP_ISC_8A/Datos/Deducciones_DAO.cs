...
namespace AgroNegocio_RH_ERP_ISC_8A.Datos
{
    class Deducciones_DAO
    {
        ...
        public bool registrar(Deduccion deduccion)
        {
            ...
            {
                throw new Exception("Error al registrar deducción. ");
            }
            return insert;
        }
        ...
        public bool editar(Deduccion deduccion)
        {
            ...
            {
                throw new Exception("Error al editar la deduccion.");
            }
            return editar;
        }
        ...
        public bool eliminar(int idP)
        {
            ...
            {
                throw new Exception("Error al eliminar la deduccion. ");
            }
            return eliminar;
        }
        ...
        public bool validarDeduccion(Deduccion deduccion)
        {
            ...
            {
                throw new Exception("Error al validar deducción. ");
            }
            return validar;
        }
    }
