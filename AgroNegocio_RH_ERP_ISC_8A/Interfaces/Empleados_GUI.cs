...
namespace AgroNegocio_RH_ERP_ISC_8A.Interfaces
{
    public partial class Empleados_GUI : Form
    {
        ...
        private void historialDePuestosToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            if (tablaEmpleados1.SelectedRows.Count == 1)
            {
                ...
                HistorialPuestos_Nuevo hp = new HistorialPuestos_Nuevo(emp, this.idEmp); /*Mandar el GUI con esos valores*/
                this.SetVisibleCore(false);
                hp.ShowDialog();
                this.SetVisibleCore(true);
                actualizar();
        ...
        private void tablaEmpleados1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void cambiarPuestoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //if (tablaEmpleados1.SelectedRows.Count == 1)
            //{
